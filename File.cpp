...
BOOL File::Open(CONST std::wstring& FileName, CONST DWORD DesiredAccess, CONST DWORD ShareMode, CONST DWORD CreationDisposition, CONST DWORD Flags, CONST BOOL QueryFileSize)
{
	try
	{
...
BOOL File::Read(LPVOID Buffer, CONST DWORD NumberOfBytesToRead, LPDWORD NumberOfBytesRead, LPOVERLAPPED Overlapped)
{
	try
	{
...
BOOL File::Write(LPCVOID Buffer, CONST DWORD NumberOfBytesToWrite, LPDWORD NumberOfBytesWritten, LPOVERLAPPED Overlapped)
{
	try
	{
